...
tiff("graphs/maps/temperature1991.tiff", units="in", width=8, height=6, res=400)
...
par(mai=c(0,0,0.2,0),xaxs="i",yaxs="i")
tiff("graphs/maps/temperature1997.tiff", units="in", width=8, height=6, res=400)
...
par(mai=c(0,0,0.2,0),xaxs="i",yaxs="i")
tiff("graphs/maps/temperature2004.tiff", units="in", width=8, height=6, res=400)
...
par(mai=c(0,0,0.2,0),xaxs="i",yaxs="i")
tiff("graphs/maps/temperature2010.tiff", units="in", width=8, height=6, res=400)
...
dev.off()
### Comparison ###
tiff("graphs/maps/temp_comparison.tiff", units="in", width=8, height=6, res=400)
